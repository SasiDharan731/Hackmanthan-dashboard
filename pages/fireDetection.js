      ...
      <div {...getRootProps({className: 'dropzone'})}>
        ...
        <p className='p-5 text'>Drag and drop footage here, or click to select files</p>
            ...
            <div className="mt-5">
                ...
                <div className="">
                    <video className='mt-5 video' src="https://hackmanthan.s3.ap-south-1.amazonaws.com/FireAccident-Footages/Police+release+CCTV+footage+of+vehicle+fire.mp4" controls>
        ...
        <Modal isOpen={modal}
                ...
                backdrop={true}>
                <ModalHeader>
                    Identifying Fire from the provided footage
                </ModalHeader>
                <ModalBody>
                        ...
                        <div className='mt-4' >
                            {
                                ...
                                <div className="center-clm">
                                    ...
                                    />
                                    <h5 className='mt-3'>Looking for fire accidents</h5>
                                </div>
                                :
                                found ?
                                <div className="">
                                    <h2 className='center'>Fire identified at:</h2>
                                ...
                                :
                                <div className="">
                                    <h2 className='text-danger'>No fire accidents identified</h2>
                                </div>
                            }
                        </div>
                    </div>
